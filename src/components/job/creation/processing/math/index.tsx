...
import MathFormComponent from './MathFormComponent';
...
const Math: React.FC<MathFormProps> = ({ /*onSubmit, index = 0,*/ item }) => {
    // const [task, setTask] = useState<MathType>({
    //     // method: method,
    //     // url: '',
    //     // value: '',
    //     // decoding: '',
        ...
        <>
            <FormContainer>
                ...
                <CollapsiblePanel isOpen={isPanelOpen}>
                    <MathFormComponent operation={item.text}></MathFormComponent>
                </CollapsiblePanel>
            </FormContainer>
        </>
    );
