...
type SearchProps = {
  additionalStylesForStyledInput?: string;
  additionalStylesForInput?: string;
};
...
const Input = styled.input<SearchProps>`
  ...
  ${(props) => props.additionalStylesForStyledInput && css`
    ${props.additionalStylesForStyledInput}
  `}
`;

const StyledInput = styled.div<SearchProps>`
  position: relative;
  & > svg {
    position: absolute;
    right: 0.5em;
  ...
  /* Additional styles passed as props */
  ${(props) => props.additionalStylesForInput && css`
    ${props.additionalStylesForInput}
  `}
`;
